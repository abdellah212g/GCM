...
<div class="w3-container w3-white w3-padding-16">
    ...
    <div class="w3-row-padding" style="margin:0 -16px;">
        <div class="w3-margin-bottom w3-half">
            ...
            <select class="w3-input w3-border" name="cars" id="civ">
        ...
        <div class="w3-margin-bottom w3-half">
            ...
            <input class="w3-input w3-border" type="date" name="date" id ="date" required>
        </div>
        <div class="w3-margin-bottom w3-half">
    ...
    <button class="w3-button w3-dark-grey" type="submit"><i class="fa fa-id-card w3-margin-right"></i> Submit</button>
    </form>
</div>
</div>